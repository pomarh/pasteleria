export default function Hero() {
    return (
        <section className="pt-24 bg-[#FFF8E1]">
            <div className="max-w-7xl mx-auto px-4 md:px-8 grid md:grid-cols-2 gap-10 items-center min-h-[90vh]">
                ...
                <div className="text-center md:text-left">
                    ...
                    <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                        <button className="bg-pink-400 hover:bg-pink-500 text-white px-6 py-3 rounded-full transition">Ver productos</button>

                        <button className="border border-pink-400 text-pink-400 px-6 py-3 rounded-full hover:bg-pink-100 transition">
                            Personalizar pedido
                        </button>
                    </div>
                </div>
                ...
                <div className="flex justify-center">
                    <img src="/img/hero2.png" alt="Pastel" className="w-110 md:w-[650px] object-contain drop-shadow-xl" />
                </div>
            </div>
        </section>
    );
